...
//     await db.execute(`
//         INSERT INTO WalkRequests (dog_id, requested_time, duration_minutes, location, status)
//         VALUES ((SELECT dog_id FROM Dogs WHERE name = 'Lucy'),
//            '2025-06-10 10:30:00', 45, 'Testplace1', 'open')
//     `);
//     await db.execute(`
//         INSERT INTO WalkRequests (dog_id, requested_time, duration_minutes, location, status)
//         VALUES ((SELECT dog_id FROM Dogs WHERE name = 'Milo'),
//            '2025-06-10 11:30:00', 45, 'Testplace2', 'open')
//         `);
//     await db.execute(`
//         INSERT INTO WalkRequests (dog_id, requested_time, duration_minutes, location, status)
//         VALUES ((SELECT dog_id FROM Dogs WHERE name = 'Rocky'),
//            '2025-06-10 12:30:00', 45, 'Testplace2', 'accepted')
//     `);
...
// with their average rating and number of completed walks.
  ...
  try {
    const [rows] = await db.execute(`
        SELECT
            ...
            RoundAVG(r.rating) AS average_rating,
            (
                SELECT COUNT(*)
